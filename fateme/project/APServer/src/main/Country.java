...
public class Country {
    ...
    private String path = "C:\\Users\\Fatima\\IdeaProjects\\APServer\\src\\main\\country.txt";
    private boolean isInGame = false;
    private String mainLetter;

    public Country(String l){
        mainLetter = l;
        concept = null;
    }
    ...
    public boolean isNameAccepted(){
        if(isInGame) {
            if (concept.startsWith(String.valueOf(mainLetter)) && search())
                return true;
        }
        return false;
    }
